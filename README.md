...
| Name | Version |
|------|------:|
| <a href="https://github.com/terraform-aws-modules/terraform-aws-opensearch" target="_blank">terraform-aws-modules/opensearch/aws</a> | 2.9.0 |
...
| create_security_group                   | Determines if a security group is created by the upstream OpenSearch module                                                                                                                                                                                                                | `bool`                                                                                                                                                                        | `false`                                                                       | no       |
...
| domain_name                             | Name of the domain                                                                                                                                                                                                                                                                         | `string`                                                                                                                                                                      | `"${local.common_name}"`                                                      | no       |
...
| security_group_create                   | Whether to attach the wrapper-managed security group ID to the domain VPC configuration                                                                                                                                                                                                    | `bool`                                                                                                                                                                        | `true`                                                                        | no       |
| security_groups_ids                     | Additional security group IDs to attach alongside the wrapper-managed group                                                                                                                                                                                                                | `list(string)`                                                                                                                                                                | `[]`                                                                          | no       |
...
| subnet_ids                              | Subnet IDs used to build the domain `vpc_options` passed to OpenSearch                                                                                                                                                                                                                     | `list(string)`                                                                                                                                                                | subnets from wrapper `data.aws_subnets.this`                                  | no       |
...
- **VPC options:** This wrapper builds the `vpc_options` block passed to the OpenSearch module from `subnet_ids` (optional; defaults to subnets resolved by the wrapper data sources), `security_group_create`, and `security_groups_ids`. Do not pass a top-level `vpc_options` map; set `subnet_ids` on each domain entry instead.
